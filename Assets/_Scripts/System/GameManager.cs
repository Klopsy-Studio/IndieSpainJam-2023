...
public class GameManager : MonoBehaviour
{
    ...
    [SerializeField] UIGameplay UIGameplayScript;
    ...
    public float Points
    {
        ...
        set
        {
            ...
            float pointsRounded = Mathf.Round(_points);

            pointsText.SetText(pointsRounded.ToString());
            pointsShop.SetText(pointsRounded.ToString());
        }
    }
